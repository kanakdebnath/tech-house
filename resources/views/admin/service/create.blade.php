                        ...
                        <form action="{{ route('services.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select name="status" id="" class="form-select">
                                    ...
                                    <option value="{{ App\Enum\StatusType::ACTIVE }}">Published</option>
                                    <option value="{{ App\Enum\StatusType::INACTIVE }}">UnPublished</option>
                                </select>
                                @error('status')
                                    <p class="mb-0 position-absolute text-danger">
                                        {{ $message }}
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="description" id="package" cols="30" rows="10"></textarea>
                                @error('description')
                                    <p class="mb-0 position-absolute text-danger">
                                        {{ $message }}
                                    </p>
