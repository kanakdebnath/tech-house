                        ...
                        <form action="{{ route('expertise.update', $expertise->id) }}" method="post"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="number" name="skill_percent" placeholder="Enter skill percent"
                                    class="form-control" value="{{ $expertise->skill_percent }}">
                                @error('skill_percent')
                                    <p class="mb-0 position-absolute text-danger">
                                        {{ $message }}
                                    </p>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select name="status" id="" class="form-select">
                                    ...
                                    <option {{ $expertise->status == App\Enum\StatusType::ACTIVE ? 'selected' : '' }}
                                        value="1">Published</option>
                                    <option {{ $expertise->status == App\Enum\StatusType::INACTIVE ? 'selected' : '' }}
