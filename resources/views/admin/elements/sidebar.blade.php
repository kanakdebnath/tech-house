    ...
    <div class="deznav-scroll">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    <i class="flaticon-381-push-pin"></i>
                    <span class="nav-text">{{ __('Expertise') }}</span>
                </a>
                <ul aria-expanded="false">

                    <li>
                        <a href="{{ route('expertise.index') }}">{{ __('All Expertise') }}</a>
                    </li>

                    <li>
                        <a href="{{ route('expertise.create') }}">{{ __('Add Expertise') }}</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li>
                        <a href="{{ route('packages.index') }}">{{ __('All Packages') }}</a>
                    </li>

                    <li>
                        <a href="{{ route('packages.create') }}">{{ __('Add Packages') }}</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    <i class="flaticon-381-push-pin"></i>
                    <span class="nav-text">{{ __('Team Members') }}</span>
                </a>
                <ul aria-expanded="false">

                    <li>
                        <a href="{{ route('team-members.index') }}">{{ __('All Team Member') }}</a>
                    </li>

                    <li>
                        <a href="{{ route('team-members.create') }}">{{ __('Add Team Member') }}</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    <i class="flaticon-381-push-pin"></i>
                    <span class="nav-text">{{ __('Service Category') }}</span>
                </a>
                <ul aria-expanded="false">

                    <li>
                        <a href="{{ route('service-categories.index') }}">{{ __('Service Category') }}</a>
                    </li>
                </ul>
            </li>
                ...
                <li>
                    ...
                    <ul aria-expanded="false">
                        @can('Controllers > UsersController > index')
                            <li
                                class="{{ DzHelper::controller() == 'UsersController' && DzHelper::action() == 'index' ? 'mm-active' : '' }}">
                        ...
                        @can('Controllers > UsersController > create')
                            <li
                                class="{{ DzHelper::controller() == 'UsersController' && DzHelper::action() == 'create' ? 'mm-active' : '' }}">
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="javascript:void(0);" class="bg-light">{{ __('Widgets') }} <span
                                class="badge badge-xs badge-danger">{{ __('Coming Soon') }}</span></a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="javascript:void(0);" class="bg-light">{{ __('Site Health') }} <span
                                class="badge badge-xs badge-danger">{{ __('Coming Soon') }}</span></a></li>
                </ul>
            </li>
